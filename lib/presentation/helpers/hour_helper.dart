...
class HourHelper {
  static getHourFieldValueByTitle(Hour hour, String _title, String _dayTimeFormatOfLang) {
    switch(_title) {
      ...
      case 'weather_main': return hour.weatherMain;
      case 'weather_desc': return hour.weatherDesc;
      case 'temperature': return hour.temperature;
      case 'temp_feels_like': return hour.tempFeelsLike;
      case 'pressure': return hour.pressure;
      case 'humidity': return hour.humidity;
      case 'atmospheric_temp': return hour.atmosphericTemp;
      case 'clouds': return hour.clouds;
      case 'wind_speed': return hour.windSpeed;
      case 'wind_degrees': return hour.windDegrees;
      case 'snow': return hour.snow;
      case 'rain': return hour.rain;
      default: return null;
    }
  }
  ...
  static getHourFieldValueBoxByTitle(Hour hour, String _title, String _dayTimeFormatOfLang, String _language) {
    ...
    var _value = getHourFieldValueByTitle(hour, _title, _dayTimeFormatOfLang);
    return _value != null
      ? Text('$_value ${hourFieldsInfo[_title]["unit"][_language]}',
